...
use Cratia\ORM\Model\Interfaces\IModelAccess;
use Cratia\ORM\Model\Traits\ModelAccess;

class Model2 implements IModelAccess
{
    use ModelAccess;
     ...
     * @return Model1
     */
    public function setProperty1(?int $property_1): Model2
    {
        $this->property_1 = $property_1;
        return $this;
    }
     ...
     * @return Model1
     */
    public function setProperty3(?int $property_3): Model2
    {
        $this->property_3 = $property_3;
        return $this;
    }
